        ...
        try {
            ...
            for (i in 0 until wanted.length()) {
                ...
                if (id != null) {
                    ...
                    v.put(Calendars.ALLOWED_REMINDERS, CalendarContract.Reminders.METHOD_DEFAULT.toString() + "," + CalendarContract.Reminders.METHOD_ALERT.toString())
                    v.put(Calendars.ALLOWED_AVAILABILITY, Events.AVAILABILITY_BUSY.toString() + "," + Events.AVAILABILITY_FREE.toString())
